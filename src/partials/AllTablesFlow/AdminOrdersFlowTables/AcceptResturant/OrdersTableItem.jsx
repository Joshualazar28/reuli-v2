    ...
    <tbody className="text-sm">
      ...
      <tr>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="flex items-center text-slate-800">
            ...
            <div className="font-medium text-sky-500">{props.customer}</div>
          </div>
        </td>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="text-left font-medium text-emerald-500">{moment(props.datetime).format('h:mm a, MMMM-Do')} </div>
        </td>
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
      ...
      */}
      <tr id={`description-${props.id}`} role="region" className={`${!descriptionOpen && 'hidden'}`}>
        ...
        <FeedRightContent acecptres={props}/>
        </td>
      </tr>
    </tbody>
  );
