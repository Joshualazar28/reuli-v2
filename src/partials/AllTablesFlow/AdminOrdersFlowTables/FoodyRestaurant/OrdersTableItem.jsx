...
import FeedRightContent from '../../../community/FeedRightContent';
  ...
  return (
    <tbody className="text-sm">
      ...
      <tr>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <ReadMoreReact text={props?.AddressLine}
            min={20}
            ideal={40}
            max={40}
            readMoreText={"read more"}/>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="text-left font-medium text-emerald-500">{props.PaymentMethod}</div>
        </td>
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className={`inline-flex font-medium rounded-full  text-white bg-indigo-600 px-2.5 py-0.5`}>{moment(props.OrderDeliveredTime).format('h:mm a')}
          </div>
        </td>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
          <div className="flex items-center">
            <button
              ...
              onClick={(e) => handleOpenDrown(e, props.OrderId)}
      ...
      */}
        ...
        <FeedRightContent foodmealid={props} orderdetail={props}/>
        </td>
      </tr>
    </tbody>
  );
