...
function PaginationNumeric({RecievedDataCOUNT}) {
const [pagecount, setpagecount] = useState('')
  console.log(RecievedDataCOUNT,' RecievedDataCOUNT')
  const pageDivTen  = RecievedDataCOUNT/10
  const showCount = pageDivTen.toFixed()
