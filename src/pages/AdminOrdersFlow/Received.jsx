...
import OrdersTable from '../../partials/AllTablesFlow/AdminOrdersFlowTables/RecicvedOrder/OrdersTable';
...
function Received() {
  ...
  const pageDivTen = RecievedDataCOUNT / 10 // divied page in to 10
    ...
    // axios.get(`https://delivigo-api.herokuapp.com/api/v6/dashboard/orders/admin?pageNo=1&status=10`)
      ...
      .then(response => {
        ...
        if (response?.data) {
          ...
          setRecievedData(response.data.result)
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            {/* Table */}
            {loading ? <> <OrdersTable RecievedData={RecievedData} selectedItems={handleSelectedItems} title={title} CreateOrderCount={CreateOrderCount} /></> : <> <Spinner animation="border" />  </>}
