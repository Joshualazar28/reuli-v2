...
import OrdersTable from '../../partials/AllTablesFlow/AdminOrdersFlowTables/Complete/OrdersTable';
...
function Complete() {
  ...
  console.log(Complete , "Complete Works");
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <main>
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            Complete
            {/* Table */}
            <OrdersTable Complete={Complete} selectedItems={handleSelectedItems} title={title} CreateOrderCount={CreateOrderCount} />
