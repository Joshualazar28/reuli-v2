...
import AuthImage from '../images/siguplimg.png';
...
function Signin() {
  ...
  const store = Store()
  console.log(store, updateStore, "joshua-Store")
  ...
  const HnadleLogin = (e) => {
    e.preventDefault();
    fetch(`https://delivigo-api.herokuapp.com/api/v2/admin/login`, {
      method: "post",
      headers: {
        "Content-Type": "application/json",
      },
      body: JSON.stringify({
        "Email":"john@delivigo.com",
        "Password":"admin123",
        "DeviceToken": "addd"
      }),
    })
    ...
    // admin123
      ...
      .then((data) => {
        ...
        console.log(Object.keys(data.result).length); // 0
        if (Object.keys(data?.result).length === 0) {
          const resmessagev = data?.ResultMessages?.map((message) => {
            ...
            <div className="max-w-sm mx-auto px-4 py-8">
              ...
              <form>
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input id="password" className="form-input w-full" type="password" name="Password"
                      ...
                      onChange={HandleSignin} autoComplete="on" />
                  </div>
                </div>
                <div className="flex items-center justify-between mt-6">
                  ...
                  <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-3" onClick={HnadleLogin} >Sign In</button>
                </div>
              </form>
              {/* Footer */}
