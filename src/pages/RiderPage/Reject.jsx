...
// import OrdersTable from '../../partials/AllTablesFlow/RiderAccepted/OrdersTable';

import RidersTable from '../../partials/RideTable/Reject/OrdersTable';
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="mb-4 sm:mb-0 flex justify-around">
                <h1 className="text-2xl  md:text-3xl text-indigo-500 font-bold"> Rider Onboarding </h1>
                <div class="relative">
