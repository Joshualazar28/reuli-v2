      ...
      <tr>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
          <div className="flex items-center text-slate-800">
            ...
            <div className="font-medium text-sky-500">{props.Name_fi}</div>
          </div>
        </td>
        ...
        <td className="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
        <button className="btn bg-indigo-500 hover:bg-indigo-600 text-white" aria-controls="feedback-modal" >Edit</button>
        <button className="btn bg-indigo-500 ml-3 hover:bg-indigo-600 text-white" aria-controls="feedback-modal" >Delete</button>
        </td>
